          ...
          >
            ...
            <main>
              <Routes>
                ...
                <Route path="/men/tops" element={<MenTops></MenTops>} />
                <Route
                  path="/men/bottoms"
                  element={<MenBottoms></MenBottoms>}
                />
                <Route path="/men/shoes" element={<MenShoes></MenShoes>} />
                <Route path="/men/bags" element={<MenBags></MenBags>} />
                <Route
                  path="/men/accessories"
                  element={<MenAccessories></MenAccessories>}
                />
                <Route path="/women/tops" element={<WomenTops></WomenTops>} />
                <Route
                  path="/women/bottoms"
                ...
                />
                <Route path="/women/bags" element={<WomenBags></WomenBags>} />
                <Route
